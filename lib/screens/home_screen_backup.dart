...
class _HomeScreenState extends State<HomeScreen> 
  ...
  // Add this method to calculate matches like in ProfileScreen
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          _buildStatDivider(),
          // Matches - clickable, using correct count
          GestureDetector(
            onTap: _navigateToMatches,
            child: _buildStatItem(
              '$_actualMatchCount', // Use session-based count
              'Matches',
              Colors.red,
